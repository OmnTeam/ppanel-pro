...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			proxyads.Table:                    proxyads.ValidColumn,
			proxyannouncement.Table:           proxyannouncement.ValidColumn,
			...
			proxytask.Table:                   proxytask.ValidColumn,
			proxyticket.Table:                 proxyticket.ValidColumn,
			proxyticketfollow.Table:           proxyticketfollow.ValidColumn,
			proxytrafficlog.Table:             proxytrafficlog.ValidColumn,
			proxyuser.Table:                   proxyuser.ValidColumn,
