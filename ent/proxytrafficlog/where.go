...
func ServerID(v int64) predicate.ProxyTrafficLog {
	return predicate.ProxyTrafficLog(sql.FieldEQ(FieldServerID, v))
}

// UserID applies equality check predicate on the "user_id" field. It's identical to UserIDEQ.
func UserID(v int64) predicate.ProxyTrafficLog {
	return predicate.ProxyTrafficLog(sql.FieldEQ(FieldUserID, v))
}
...
func SubscribeID(v int64) predicate.ProxyTrafficLog {
	return predicate.ProxyTrafficLog(sql.FieldEQ(FieldSubscribeID, v))
}
...
func Timestamp(v time.Time) predicate.ProxyTrafficLog {
	return predicate.ProxyTrafficLog(sql.FieldEQ(FieldTimestamp, v))
}
...
func UserIDNEQ(v int64) predicate.ProxyTrafficLog {
	return predicate.ProxyTrafficLog(sql.FieldNEQ(FieldUserID, v))
}

// UserIDIn applies the In predicate on the "user_id" field.
func UserIDIn(vs ...int64) predicate.ProxyTrafficLog {
	return predicate.ProxyTrafficLog(sql.FieldIn(FieldUserID, vs...))
}

// UserIDNotIn applies the NotIn predicate on the "user_id" field.
func UserIDNotIn(vs ...int64) predicate.ProxyTrafficLog {
	return predicate.ProxyTrafficLog(sql.FieldNotIn(FieldUserID, vs...))
}

// UserIDGT applies the GT predicate on the "user_id" field.
func UserIDGT(v int64) predicate.ProxyTrafficLog {
	return predicate.ProxyTrafficLog(sql.FieldGT(FieldUserID, v))
}

// UserIDGTE applies the GTE predicate on the "user_id" field.
func UserIDGTE(v int64) predicate.ProxyTrafficLog {
	return predicate.ProxyTrafficLog(sql.FieldGTE(FieldUserID, v))
}

// UserIDLT applies the LT predicate on the "user_id" field.
func UserIDLT(v int64) predicate.ProxyTrafficLog {
	return predicate.ProxyTrafficLog(sql.FieldLT(FieldUserID, v))
}

// UserIDLTE applies the LTE predicate on the "user_id" field.
func UserIDLTE(v int64) predicate.ProxyTrafficLog {
	return predicate.ProxyTrafficLog(sql.FieldLTE(FieldUserID, v))
}
...
func SubscribeIDNEQ(v int64) predicate.ProxyTrafficLog {
	return predicate.ProxyTrafficLog(sql.FieldNEQ(FieldSubscribeID, v))
}

// SubscribeIDIn applies the In predicate on the "subscribe_id" field.
func SubscribeIDIn(vs ...int64) predicate.ProxyTrafficLog {
	return predicate.ProxyTrafficLog(sql.FieldIn(FieldSubscribeID, vs...))
}
...
func TimestampNEQ(v time.Time) predicate.ProxyTrafficLog {
	return predicate.ProxyTrafficLog(sql.FieldNEQ(FieldTimestamp, v))
}

// TimestampIn applies the In predicate on the "timestamp" field.
func TimestampIn(vs ...time.Time) predicate.ProxyTrafficLog {
	return predicate.ProxyTrafficLog(sql.FieldIn(FieldTimestamp, vs...))
}

// TimestampNotIn applies the NotIn predicate on the "timestamp" field.
func TimestampNotIn(vs ...time.Time) predicate.ProxyTrafficLog {
	return predicate.ProxyTrafficLog(sql.FieldNotIn(FieldTimestamp, vs...))
}

// TimestampGT applies the GT predicate on the "timestamp" field.
func TimestampGT(v time.Time) predicate.ProxyTrafficLog {
	return predicate.ProxyTrafficLog(sql.FieldGT(FieldTimestamp, v))
}

// TimestampGTE applies the GTE predicate on the "timestamp" field.
func TimestampGTE(v time.Time) predicate.ProxyTrafficLog {
	return predicate.ProxyTrafficLog(sql.FieldGTE(FieldTimestamp, v))
}

// TimestampLT applies the LT predicate on the "timestamp" field.
func TimestampLT(v time.Time) predicate.ProxyTrafficLog {
	return predicate.ProxyTrafficLog(sql.FieldLT(FieldTimestamp, v))
}

// TimestampLTE applies the LTE predicate on the "timestamp" field.
func TimestampLTE(v time.Time) predicate.ProxyTrafficLog {
	return predicate.ProxyTrafficLog(sql.FieldLTE(FieldTimestamp, v))
}
