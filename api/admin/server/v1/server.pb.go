...
const file_admin_server_v1_server_proto_rawDesc = "" +
	"\n" +
	"\x1cadmin/server/v1/server.proto\x12\x13api.admin.server.v1\x1a\x1cgoogle/api/annotations.proto\"\xe7\f\n" +
	"\bProtocol\x12\x12\n" +
	...
	"\rfingerprint32\x18\a \x01(\tR\rfingerprint32\x12.\n" +
	...
	"\fsubscribe_id\x18\x04 \x01(\tR\vsubscribeId\x12\x18\n" +
	...
	"\x06status\x18\x06 \x01(\tR\x06status\"\xe8\x02\n" +
	"\x06Server\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	...
	"\n" +
	"updated_at\x18\x0e \x01(\x03R\tupdatedAtB\n" +
	"\n" +
	"\b_enabled\"\xc2\x01\n" +
	...
	"\tprotocols\x18\x06 \x03(\v2\x1d.api.admin.server.v1.ProtocolR\tprotocols\"G\n" +
	...
	"\x04data\x18\x03 \x01(\v2%.api.admin.server.v1.CreateServerDataR\x04data\"\xd2\x01\n" +
	...
	"\x04code\x18\x01 \x01(\x05R\x04code\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x129\n" +
	"\x04data\x18\x03 \x01(\v2%.api.admin.server.v1.UpdateServerDataR\x04data\"%\n" +
	...
	"\x04code\x18\x01 \x01(\x05R\x04code\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x129\n" +
	"\x04data\x18\x03 \x01(\v2%.api.admin.server.v1.DeleteServerDataR\x04data\"Y\n" +
	"\x17FilterServerListRequest\x12\x12\n" +
	...
	"\x04data\x18\x03 \x01(\v2).api.admin.server.v1.FilterServerListDataR\x04data\"+\n" +
	"\x19GetServerProtocolsRequest\x12\x0e\n" +
	...
	"\x04code\x18\x01 \x01(\x05R\x04code\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12?\n" +
	"\x04data\x18\x03 \x01(\v2+.api.admin.server.v1.GetServerProtocolsDataR\x04data\"\xf3\x01\n" +
	...
	"\x04data\x18\x03 \x01(\v2#.api.admin.server.v1.CreateNodeDataR\x04data\"\x83\x02\n" +
	...
	"\x04code\x18\x01 \x01(\x05R\x04code\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x127\n" +
	"\x04data\x18\x03 \x01(\v2#.api.admin.server.v1.DeleteNodeDataR\x04data\"W\n" +
	"\x15FilterNodeListRequest\x12\x12\n" +
	"\x04page\x18\x01 \x01(\x05R\x04page\x12\x12\n" +
	"\x04size\x18\x02 \x01(\x05R\x04size\x12\x16\n" +
	...
	"\x04code\x18\x01 \x01(\x05R\x04code\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12;\n" +
	"\x04data\x18\x03 \x01(\v2'.api.admin.server.v1.FilterNodeListDataR\x04data\"Q\n" +
	"\x17ToggleNodeStatusRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1b\n" +
	"\x06enable\x18\x02 \x01(\bH\x00R\x06enable\x88\x01\x01B\t\n" +
	"\a_enable\"E\n" +
	...
	"\x04code\x18\x01 \x01(\x05R\x04code\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12=\n" +
	"\x04data\x18\x03 \x01(\v2).api.admin.server.v1.ToggleNodeStatusDataR\x04data\"\x15\n" +
	"\x13QueryNodeTagRequest\"&\n" +
	"\x10QueryNodeTagData\x12\x12\n" +
	"\x04tags\x18\x01 \x03(\tR\x04tags\"|\n" +
	"\x11QueryNodeTagReply\x12\x12\n" +
	"\x04code\x18\x01 \x01(\x05R\x04code\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x129\n" +
	"\x04data\x18\x03 \x01(\v2%.api.admin.server.v1.QueryNodeTagDataR\x04data\"\x1d\n" +
	"\x1bHasMigrateServerNodeRequest\";\n" +
	...
	"\x04data\x18\x03 \x01(\v2-.api.admin.server.v1.HasMigrateServerNodeDataR\x04data\"\x1a\n" +
	"\x18MigrateServerNodeRequest\"E\n" +
	...
	"\x04code\x18\x01 \x01(\x05R\x04code\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12>\n" +
	"\x04data\x18\x03 \x01(\v2*.api.admin.server.v1.MigrateServerNodeDataR\x04data\"E\n" +
	"\x10ResetSortRequest\x121\n" +
	"\x04sort\x18\x01 \x03(\v2\x1d.api.admin.server.v1.SortItemR\x04sort\")\n" +
