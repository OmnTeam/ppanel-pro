...
const file_admin_coupon_v1_coupon_proto_rawDesc = "" +
	"\n" +
	"\x1cadmin/coupon/v1/coupon.proto\x12\x13api.admin.coupon.v1\x1a\x1cgoogle/api/annotations.proto\"\xc7\x02\n" +
	...
	"expireTime\x12\x1d\n" +
	"\n" +
	"user_limit\x18\b \x01(\x03R\tuserLimit\x12\x1c\n" +
	"\tsubscribe\x18\t \x03(\tR\tsubscribe\x12\x1d\n" +
	"\n" +
	"used_count\x18\n" +
	" \x01(\x03R\tusedCount\x12\x1b\n" +
	"\x06enable\x18\v \x01(\bH\x00R\x06enable\x88\x01\x01B\t\n" +
	"\a_enable\"A\n" +
	"\x11CreateCouponReply\x12\x12\n" +
	"\x04code\x18\x01 \x01(\x05R\x04code\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\"\xd7\x02\n" +
	...
	"\tsubscribe\x18\n" +
	" \x03(\tR\tsubscribe\x12\x1d\n" +
	"\n" +
	"used_count\x18\v \x01(\x03R\tusedCount\x12\x1b\n" +
