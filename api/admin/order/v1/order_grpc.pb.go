...
func (c *orderServiceClient) GetOrderList(ctx context.Context, in *GetOrderListRequest, opts ...grpc.CallOption) (*GetOrderListReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedOrderServiceServer) GetOrderList(context.Context, *GetOrderListRequest) (*GetOrderListReply, error) {
...
var OrderService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/admin/order/v1/order.proto",
}
