...
const file_admin_system_v1_system_proto_rawDesc = "" +
	...
	"\x0ftrial_subscribe\x18\x03 \x01(\x05R\x0etrialSubscribe\x12\x1d\n" +
	"\n" +
	"trial_time\x18\x04 \x01(\x05R\ttrialTime\x12&\n" +
	...
	"\x11ip_register_limit\x18\a \x01(\x05R\x0fipRegisterLimit\x12;\n" +
	"\x1aip_register_limit_duration\x18\b \x01(\x05R\x17ipRegisterLimitDuration\"\xd5\x01\n" +
	"\n" +
	"SiteConfig\x12\x12\n" +
	...
	"\x18enable_ip_register_limit\x18\x06 \x01(\bR\x15enableIpRegisterLimit\x12*\n" +
	"\x11ip_register_limit\x18\a \x01(\x05R\x0fipRegisterLimit\x12;\n" +
	"\x1aip_register_limit_duration\x18\b \x01(\x05R\x17ipRegisterLimitDuration\"4\n" +
	...
	"\x04data\x18\x03 \x01(\v2/.api.admin.system.v1.UpdateVerifyCodeConfigDataR\x04data\"\xb6\x04\n" +
	"\fVerifyConfig\x12,\n" +
	"\x12turnstile_site_key\x18\x01 \x01(\tR\x10turnstileSiteKey\x12)\n" +
	"\x10turnstile_secret\x18\x02 \x01(\tR\x0fturnstileSecret\x129\n" +
	"\x19enable_user_login_captcha\x18\x03 \x01(\bR\x16enableUserLoginCaptcha\x12?\n" +
	"\x1cenable_user_register_captcha\x18\x04 \x01(\bR\x19enableUserRegisterCaptcha\x12J\n" +
	"\"enable_user_reset_password_captcha\x18\x05 \x01(\bR\x1eenableUserResetPasswordCaptcha\x12!\n" +
	"\fcaptcha_type\x18\x06 \x01(\tR\vcaptchaType\x12;\n" +
	"\x1aenable_admin_login_captcha\x18\a \x01(\bR\x17enableAdminLoginCaptcha\x12.\n" +
	"\x13enable_login_verify\x18\b \x01(\bR\x11enableLoginVerify\x124\n" +
	"\x16enable_register_verify\x18\t \x01(\bR\x14enableRegisterVerify\x12?\n" +
	"\x1cenable_reset_password_verify\x18\n" +
	" \x01(\bR\x19enableResetPasswordVerify\"\x18\n" +
	"\x16GetVerifyConfigRequest\"{\n" +
	"\x14GetVerifyConfigReply\x12\x12\n" +
	"\x04code\x18\x01 \x01(\x05R\x04code\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x125\n" +
	"\x04data\x18\x03 \x01(\v2!.api.admin.system.v1.VerifyConfigR\x04data\"\xc3\x04\n" +
	...
	"\x16enable_register_verify\x18\t \x01(\bR\x14enableRegisterVerify\x12?\n" +
	"\x1cenable_reset_password_verify\x18\n" +
	" \x01(\bR\x19enableResetPasswordVerify\"2\n" +
