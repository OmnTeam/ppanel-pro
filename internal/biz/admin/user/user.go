...
type UserRepo interface {
	...
	GetUserLoginLogs(ctx context.Context, page, size int32, userID *int64, date string) ([]*ent.ProxySystemLog, int64, error)
}
...
// GetUserLoginLogs 获取用户登录日志
func (uc *UserUsecase) GetUserLoginLogs(ctx context.Context, page, size int32, userID *int64, date string) ([]*ent.ProxySystemLog, int64, error) {
