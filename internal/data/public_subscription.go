...
func (r *publicSubscriptionRepo) GetAvailableNodes(ctx context.Context, userSubscribe *subscriptionbiz.UserSubscribe) ([]*subscriptionbiz.NodeInfo, error) {
	...
	for _, node := range nodes {
		...
		nodeInfo := &subscriptionbiz.NodeInfo{
			...
			OmniflowProfilePath:                matched.OmniflowProfilePath,
			OmniflowProfileJson:                matched.OmniflowProfileJson,
			OmniflowServerHost:                 matched.OmniflowServerHost,
			OmniflowServerPort:                 int(matched.OmniflowServerPort),
			...
			OmniflowH3FallbackEnabled:          matched.OmniflowH3FallbackEnabled,
			OmniflowH3FallbackPolicy:           matched.OmniflowH3FallbackPolicy,
			OmniflowH3FallbackTimeoutMs:        int(matched.OmniflowH3FallbackTimeoutMs),
			OmniflowH3FallbackRetryBudget:      int(matched.OmniflowH3FallbackRetryBudget),
			OmniflowH3FallbackSmokeEnabled:     matched.OmniflowH3FallbackSmokeEnabled,
			OmniflowH3FallbackSmokeIntervalSec: int(matched.OmniflowH3FallbackSmokeIntervalSec),
			OmniflowH3FallbackSmokeTimeoutMs:   int(matched.OmniflowH3FallbackSmokeTimeoutMs),
			OmniflowMaxAgeSec:                  int(matched.OmniflowMaxAgeSec),
			OmniflowIdleTimeoutSec:             int(matched.OmniflowIdleTimeoutSec),
			OmniflowMaxConnections:             int(matched.OmniflowMaxConnections),
			...
			OmniflowTrafficShapingEnabled:      matched.OmniflowTrafficShapingEnabled,
			...
			OmniflowFallbackEnabled:            matched.OmniflowFallbackEnabled,
			OmniflowFallbackTargetScheme:       matched.OmniflowFallbackTargetScheme,
			OmniflowFallbackTargetHost:         matched.OmniflowFallbackTargetHost,
			OmniflowFallbackTargetPort:         int(matched.OmniflowFallbackTargetPort),
			OmniflowFallbackHostHeader:         matched.OmniflowFallbackHostHeader,
			OmniflowFallbackTLSSNI:             matched.OmniflowFallbackTLSSNI,
			OmniflowFallbackCarrierEnabled:     matched.OmniflowFallbackCarrierEnabled,
			OmniflowFallbackConnectTunnel:      matched.OmniflowFallbackConnectTunnel,
